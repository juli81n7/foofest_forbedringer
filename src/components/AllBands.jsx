    ...
    <section className="all_bands">
      ...
      <div className="filterbar">
        ...
        <label className="search_label" htmlFor="search">
          Search
          <input value={message} onChange={handleChange} id="search" name="search" className="mainsearch" placeholder="Find your farvorite band" type="search" />
        </label>
      </div>
      <Recommended>
        {bands.map((myband) => (
